...
typedef struct nodo*Tlista; //difenir   variable  un puntero a un nodo    declarando

void insertarInicio(Tlista & lista, int valor)//funcion
{
	Tlista q;
	q=new(struct nodo);
	q->nro=valor;
...
void insertarFinal(Tlista &lista,int valor) //funciones
{
...
void menu1()
{
	...
	cout<<"7.ELIMINAR ELEMENTES CON VALAR 'V' "<<endl;
